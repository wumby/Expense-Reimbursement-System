...
public class ReimbursementDao {
    ...
    public InputStream getReimbursementImage(int aId, int uId) throws SQLException {
        try (Connection con = ConnectionUtility.getConnection()) {
            String sql = "SELECT r.reimb_receipt " +
                    "FROM reimbursements r " +
                    "WHERE r.reimb_id = ? AND r.reimb_author= ?";
            ...
            if (rs.next()) {
                InputStream is = rs.getBinaryStream("receipt_image");
